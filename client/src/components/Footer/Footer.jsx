...
import { LINKEDIN, TWITTER, GITHUB, INSTAGRAM, COMPANY_NAME_1, COMPANY_NAME_2, COPYRIGHT, ICON, NAVLINKS } from '../../utils/data'
import "./Footer.css"
    ...
    <div className='footer'>
      <div className="footer-left">
        <div className="footer-logo">
          <div className="footer-logo-img"><i className={ICON} /></div>
